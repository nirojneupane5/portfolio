...
const AboutPage = () => {
  return (
    <main className="flex w-full flex-col items-center justify-center">
      <AniminatedText text="Passion Fuels Purpose!" />
      <div className="grid grid-cols-1 lg:grid-cols-8 gap-16 w-full px-3">
        <div className="col-span-3 flex flex-col lg:items-start lg:justify-start text-justify">
          <h1 className="py-4 text-lg font-bold uppercase text-black/75 text-center">
            Biography
          </h1>
          <p className="font-medium">
            Hi, I'm Niroj Neupane, a web developer with a passion for creating
            beautiful, functional, and user-centered digital experiences. With 5
            months of experience in the field. I am always looking for new and
        ...
        <div className="col-span-2 flex flex-col justify-between lg:item-end text-center">
          <div className="flex flex-col lg:item-end lg:justify-center">
